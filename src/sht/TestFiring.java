...
/**
 * This tests for variability in bullet power administered by the robot Michelangelo.
 * 
 * @author Professor Philip Johnson
 */
public class TestFiring extends RobotTestBed {

  // True if Michelangelo has fired a bullet with power less than 1.4;
  boolean firePowerReachLevelOne = false;
  // True if Michelangelo has fired a bullet with power between 1.5 to 1.9;
  boolean firePowerReachLevelTwo = false;
  // True if Michelangelo has fired a bullet with power between 2.0 to 2.4;
  boolean firePowerReachLevelThree = false;
  // True if Michelangelo has fired a bullet with power greater than 2.4;
   ...
   * to see if there is any variability in bullet power, proving that Michelangelo is using
  ...
  /**
   * After running all matches, determine if Michelangelo has had variability in its bullet power.
   * 
