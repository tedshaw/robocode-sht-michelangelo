 ...
 * This test simply verifies that Michelangelo always beats SpinBot.
 * 
 ...
 * @author Ted Shaw
 */
public class TestVersusSpinBot extends RobotTestBed {
  
  /**
   * Specifies that SpinBot and Michelangelo are to be matched up in this test case.
   * 
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.SpinBot,sht.Michelangelo";
  }
  ...
  /**
   * The actual test, which asserts that Michelangelo has won every round against SpinBot.
   * 
