 ...
 * This test simply verifies that Michelangelo always beats SittingDuck.
 * 
 ...
 * @author Ted Shaw
 */
public class NoTestVersusCorners extends RobotTestBed {
  ...
  /**
   * The actual test, which asserts that Michelangelo has won every round against SittingDuck.
   * 
