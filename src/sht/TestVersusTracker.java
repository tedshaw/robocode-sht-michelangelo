 ...
 * This test simply verifies that Michelangelo always beats Tracker.
 * 
 ...
 * @author Ted Shaw
 */
public class TestVersusTracker extends RobotTestBed {

  /**
   * Specifies that Tracker and Michelangelo are to be matched up in this test case.
   * 
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.Tracker,sht.Michelangelo";
  }
  ...
  /**
   * The actual test, which asserts that Michelangelo has won every round against Tracker.
   * 
