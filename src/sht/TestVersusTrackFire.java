 ...
 * This test simply verifies that Michelangelo always beats TrackFire.
 * 
 ...
 * @author Ted Shaw
 */
public class TestVersusTrackFire extends RobotTestBed {

  /**
   * Specifies that TrackFire and Michelangelo are to be matched up in this test case.
   * 
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.TrackFire,sht.Michelangelo";
  }
  ...
  /**
   * The actual test, which asserts that Michelangelo has won every round against TrackFire.
   * 
