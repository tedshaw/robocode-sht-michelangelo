 ...
 * This test simply verifies that Michelangelo always beats Fire.
 * 
 ...
 * @author Ted Shaw
 */
public class TestVersusFire extends RobotTestBed {
  
  /**
   * Specifies that Fire and Michelangelo are to be matched up in this test case.
   * 
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.Fire,sht.Michelangelo";
  }
  ...
  /**
   * The actual test, which asserts that Michelangelo has won every round against Fire.
   * 
