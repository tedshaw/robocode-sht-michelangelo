 ...
 * @author Ted Shaw
 */
public class TestVersusWalls extends RobotTestBed {

  /**
   * Specifies that Walls and Michelangelo are to be matched up in this test case.
   * 
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.Walls,sht.Michelangelo";
  }
  ...
  /**
   * The actual test, which asserts that Michelangelo has won every round against Walls.
   * 
