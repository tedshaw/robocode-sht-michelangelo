 ...
 * This test simply verifies that Michelangelo always beats RamFire.
 * 
 ...
 * @author Ted Shaw
 */
public class TestVersusRamFire extends RobotTestBed {
  
  /**
   * Specifies that RamFire and Michelangelo are to be matched up in this test case.
   * 
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.RamFire,sht.Michelangelo";
  }
  ...
  /**
   * The actual test, which asserts that Michelangelo has won every round against RamFire.
   * 
