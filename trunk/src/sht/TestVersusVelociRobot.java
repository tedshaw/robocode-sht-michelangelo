...
/**
 * Illustrates JUnit testing of Robocode robots. This test simply verifies that Michelangelo always
 * beats VelociRobot.
 * 
 ...
 * @author Ted Shaw
 */
public class TestVersusVelociRobot extends RobotTestBed {

  /**
   * Specifies that VelociRobot and Michelangelo are to be matched up in this test case.
   * 
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.VelociRobot,sht.Michelangelo";
  }
  ...
  /**
   * The actual test, which asserts that Michelangelo has won every round against VelociRobot.
   * 
