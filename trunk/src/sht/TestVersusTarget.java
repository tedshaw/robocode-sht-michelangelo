 ...
 * This test simply verifies that Michelangelo always beats Target.
 * 
 ...
 * @author Ted Shaw
 */
public class TestVersusTarget extends RobotTestBed {
  
  /**
   * Specifies that Target and Michelangelo are to be matched up in this test case.
   * 
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.Target,sht.Michelangelo";
  }
  ...
  /**
   * The actual test, which asserts that Michelangelo has won every round against Target.
   * 
